...
const CreateClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (selected) {
        const { data } = await api.updateClient(selected.id, formData);
      ...
      console.log(error);
      toast.error("Client илгээх үед алдаа гарлаа!");
    }
  };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      toast.error("Client устгах хүсэлт илгээх үед алдаа гарлаа!");
    }
  };
  ...
  return (
    <Layout>
      <Breadcrumbs title="Хамтын Ажиллагаа" />
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="login-form">
                            <h2>{selected ? "Хамтрагч засах" : "Хамтрагч үүсгэх"}</h2>
                            ...
                            <form className="form" onSubmit={handleSubmit}>
                                <div className="row">
                                  ...
                                  <div className="col-lg-12">
                                    <div className="form-group">
                                      <label htmlFor="photo">
                                        {formData.photo ? formData.title : "Зураг сонгох"}
                                      </label>
                                      <FileBase 
                                        type="file"
                                        id="photo"
